    ...
    >
      ...
      <div className="absolute bottom-0 w-full p-8 flex flex-col items-center z-20">
        {currentFeatureIndex === features.length - 1 ? (
                    <button
                        onClick={handleGetStarted}
                        className={`px-8 py-3 font-bold rounded-lg text-white bg-gradient-to-r from-blue-500 to-blue-600 hover:scale-105 shadow-xl transition-all duration-500 ease-out animate-pop-in cursor-pointer`}
                    >
                        Get Started
                    </button>
                ): (
      ...
      {currentFeatureIndex > 0 && (
        <button onClick={goToPrev} className="absolute left-4 top-1/2 -translate-y-1/2 p-2 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-sm transition-colors z-20 cursor-pointer" aria-label="Previous slide">
      ...
      {currentFeatureIndex < features.length - 1 && (
        <button onClick={goToNext} className="absolute right-4 top-1/2 -translate-y-1/2 p-2 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-sm transition-colors z-20 cursor-pointer" aria-label="Next slide">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
