      ...
      >
        ...
        <div className="p-4 border-b border-border bg-card text-foreground flex items-center justify-between flex-shrink-0 h-[65px]">
          ...
          <button
            ...
            className="hidden lg:block text-muted-foreground hover:text-foreground focus:outline-none rounded-lg p-1 cursor-pointer"
          >
            {isContracted ? (
              isHovering ? (
        ...
        {/* Navigation */}
        <nav className="flex-1 p-4 overflow-y-auto min-h-0 bg-card text-foreground">
