...
const ProfileModal: React.FC<ProfileModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleClose = () => {
    ...
    if (isEditing) {
      setIsEditing(false);
      setUserProfile(initialUserProfile); // Reset to initial state
    }
    onClose();
  };
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black bg-opacity-60 animate-fade-in">
        {/* Modal content */}
        <div className="w-full max-w-6xl h-[700px] mx-4 rounded-xl shadow-2xl bg-gray-800 flex overflow-hidden animate-slide-in">
