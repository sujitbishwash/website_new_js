...
const NotificationsIcon = () => (
  <svg
    ...
    aria-hidden="true"
  >
    <path d="M10 2.043a6.705 6.705 0 0 1 6.666 5.978l.561 5.15.009.164c0 .816-.662 1.496-1.498 1.496h-1.836a3.999 3.999 0 0 1-7.804 0H4.262a1.5 1.5 0 0 1-1.49-1.66l.562-5.15.043-.317A6.705 6.705 0 0 1 10 2.044M7.48 14.831a2.666 2.666 0 0 0 5.038 0zM10 3.373a5.375 5.375 0 0 0-5.31 4.538l-.033.254-.562 5.15c-.01.1.067.186.167.186h11.476a.17.17 0 0 0 .167-.15v-.036l-.562-5.15A5.375 5.375 0 0 0 10 3.373" />
  </svg>
);
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case "Notifications":
        return (
          <div>
            <h1 className="text-3xl  text-white mb-6">Notifications</h1>
      ...
      case "Development":
        return (
          <div>
            <h1 className="text-3xl  text-white mb-6">Development Tools</h1>
    ...
    <>
      ...
      <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/20 backdrop-blur-sm animate-fade-in">
        ...
        >
          <button
            onClick={handleClose}
            className="absolute top-4 right-4 p-2 text-gray-400 rounded-full hover:bg-gray-700 hover:text-white transition-colors z-10 cursor-pointer"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
