  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/20 backdrop-blur-sm animate-fade-in p-4">
        <div
          ref={modalRef}
          className="relative w-full max-w-4xl h-[90vh] max-h-[620px] rounded-xl shadow-2xl bg-card flex flex-col md:flex-row overflow-hidden animate-slide-in"
        >
          <button
            onClick={handleClose}
          ...
          <nav className="w-full md:w-1/3 lg:w-1/4 bg-background p-4 flex-shrink-0 border-b md:border-b-0 md:border-r border-foreground/20">
            <h2 className="text-xl text-muted-foreground/70 ml-4 mt-2 mb-4 hidden md:block">
              Settings
            </h2>
