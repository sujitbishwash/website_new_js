...
const MarkedForReviewIcon = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M8 16C3.58172 16 0 12.4183 0 8C0 3.58172 3.58172 0 8 0C12.4183 0 16 3.58172 16 8C16 12.4183 12.4183 16 8 16ZM7.25 11.5L12 8L7.25 4.5V11.5Z" fill="#6366F1"/>
...
const AnsweredAndMarkedIcon = () => (
    <div className="relative">
        <AnsweredIcon />
        <svg className="absolute -bottom-1 -right-1" width="8" height="8" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default function App() {
  const instructions = {
    ...
    legend: [
      { icon: <NotVisitedIcon />, text: "You have not visited the question yet." },
      { icon: <NotAnsweredIcon />, text: "You have not answered the question." },
      { icon: <AnsweredIcon />, text: "You have answered the question." },
      { icon: <MarkedForReviewIcon />, text: "You have not answered the question, but have marked the question for review." },
      { icon: <AnsweredAndMarkedIcon />, text: "You have answered the question, but marked it for review." },
    ],
    markedForReviewNote: "The Marked for Review status for a question simply indicates that you would like to look at that question again. If a question is answered and Marked for Review, your answer for that question will be considered in the evaluation.",
    navigating: [
    ...
    <div className="bg-gray-900 text-gray-300 min-h-screen font-sans p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto bg-gray-800 rounded-2xl shadow-2xl shadow-indigo-500/10 overflow-hidden">
        ...
        <header className="flex justify-between items-center p-6 border-b border-gray-700">
          <h1 className="text-2xl sm:text-3xl font-bold text-white">Exam Instructions</h1>
        ...
        <main className="p-6 sm:p-8 space-y-8">
          ...
          <section>
            <h2 className="text-xl font-semibold text-indigo-400 mb-4">General Instructions</h2>
            <div className="space-y-3 text-gray-300">
              ...
              <p className="pt-2 italic text-gray-400">{instructions.markedForReviewNote}</p>
            </div>
          </section>

          {/* Navigating to a Question */}
          <section>
            <h2 className="text-xl font-semibold text-indigo-400 mb-4">Navigating to a Question</h2>
            <div className="space-y-3 text-gray-300">
              ...
              <p className="font-semibold text-amber-400">{instructions.navigating[4]}</p>
              <div className="p-4 bg-gray-700/50 border border-gray-600 rounded-lg mt-2">
                <p className="text-gray-400">You can shuffle between sections and questions anytime during the examination as per your convenience.</p>
              </div>
            </div>
          </section>
          ...
          <section>
            <h2 className="text-xl font-semibold text-indigo-400 mb-4">Answering a Question</h2>
            <div className="space-y-3 text-gray-300">
        ...
        <footer className="flex justify-between items-center p-6 border-t border-gray-700">
          <button className="px-6 py-2 font-semibold text-white bg-gray-600 hover:bg-gray-500 rounded-lg transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-gray-400">
            Previous
          </button>
          <button className="px-8 py-2 font-bold text-white bg-indigo-600 hover:bg-indigo-500 rounded-lg transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-indigo-400 shadow-lg shadow-indigo-500/30">
            Next
          </button>
        </footer>
      </div>
