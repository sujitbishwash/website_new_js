      ...
      >
              ...
              {[1, 2, 3, 4, 5].map((ratingValue) => (
                ...
                >
                  <button
                    ...
                    className="cursor-pointer p-1 rounded-full transition-transform duration-200 ease-in-out enabled:hover:scale-140 motion-reduce:transition-none motion-reduce:hover:transform-none"
                  >
                    <SmileyIcon rating={ratingValue} active={hoverRating !== null ? ratingValue <= hoverRating : rating !== null ? ratingValue === rating : true} />
                    </button>
                  <span
        ...
        <div className="flex-shrink-0 flex justify-end items-center gap-4 p-5 border-t border-border bg-card rounded-b-2xl">
          ...
          <button
            type="submit"
            disabled={
              (rating != null && rating < 4 && comment.length == 0) ||
              rating === null ||
