...
//wrong
const Button6 = ({ size = 64, number = 1, onClick = () => {} }) => {
  const fontSize = size * 0.5; // Dynamic font size
  return (
    <button
      onClick={onClick}
      className="relative flex items-center justify-center rounded-sm bg-gradient-to-b from-red-400 to-red-600 border border-red-500 transition-all hover:scale-105 hover:shadow-lg active:shadow-inner text-white"
      style={{ width: size, height: size }}
    >
      <span className="font-bold " style={{ fontSize: `${fontSize}px` }}>
        {number}
...
//right
const Button7 = ({ size = 64, number = 1, onClick = () => {} }) => {
  const fontSize = size * 0.5; // Dynamic font size
  return (
    <button
      onClick={onClick}
      className="relative flex items-center justify-center rounded-sm bg-gradient-to-b from-green-400 to-green-600 border border-green-500 transition-all hover:scale-105 hover:shadow-lg active:shadow-inner text-white"
      style={{ width: size, height: size }}
    >
      <span className="font-bold " style={{ fontSize: `${fontSize}px` }}>
        {number}
